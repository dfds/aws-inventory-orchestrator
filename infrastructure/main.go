...
func main() {
	...
	aws.IamCreateRole("billing-admin", envMap["INVENTORY_ORCHESTRATOR_ROLE"], "", orchTrustDoc, orchPolicyDoc, 3600)
	...
	aws.IamCreateRole("inventory-runner-admin", envMap["INVENTORY_RUNNER_ROLE"], "", runnerTrustDoc, runnerPolicyDoc, 3600)
